...
export const WARRANTY_HERO_FEATURES = [
  ...
  },
  {
    ...
    description: 'Sản phẩm được kiểm định kỹ lưỡng, độ bền vượt trội theo thời gian.',
  },
] as const
...
export const WARRANTY_TERM_CARDS: WarrantyTermCard[] = [
  {
    ...
    items: [
      { label: '60 tháng:', text: 'Đối với kết cấu khung gỗ (bàn, ghế, tủ, giường...)' },
      { label: '24 tháng:', text: 'Đối với phụ kiện (ray trượt, bản lề, tay nắm...)' },
      {
        label: '12 tháng:',
  ...
  },
  {
    ...
    intro: 'Sản phẩm được bảo hành miễn phí khi đáp ứng đầy đủ các điều kiện sau:',
    items: [
